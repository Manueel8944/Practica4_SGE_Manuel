...
\subsection{Vista en formato Kanban}
...
\subsection{Fecha asignada y formato Calendar}
...
\subsection{Ejemplares de comics}
...
En esta actividad como la anterior hay que crear un módulo desde cero que gestione un instituto, con sus profesores, alumnos, ciclos y modulos. Para empezar tenemos que crear la estructura de carpetas de nuestro modulo con sus modelos y sus vistas correspondientes además de sus archivos de configuración necesarios.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{images/estructura-carpetas-instituto.png}
\end{figure}
Archivos de configuracion necesarios para el funcionamiento e instalacion del módulo:
Este es el manifest, aqui para que funcione es fundamental poner todas las vistas que tengamos
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/manifest-instituto.png}
\end{figure}
Este es el init, aqui hacemos que se refiera a la carpeta de models que tiene otro init que se ejecutara
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{images/init-instituto.png}
\end{figure}
Este es el init dentro de models que apunta a todos los modelos que tengamos
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.3\textwidth]{images/init-models-instituto.png}
\end{figure}

Ahora vamos a rellenar los archivos de los modelos y vistas para que funcione, la explicacion del código esta en los comentarios de El

\begin{figure}[H] Modulo ciclo
\begin{lstlisting}
...
\begin{figure}[H] Modulo modulo formativo
\begin{lstlisting}
...
\begin{figure}[H] Modulo profesor
\begin{lstlisting}
...
\begin{figure}[H] Vista ciclo
\begin{lstlisting}
<odoo>
    <!-- Aqui se hace un formulario para crear nuevos ciclos -->
    <record id="view_ciclo_form" model="ir.ui.view">
        <field name="name">instituto.ciclo.form</field>
        <field name="model">instituto.ciclo</field>
        <field name="arch" type="xml">
            <form string="Ciclo Formativo">
                <sheet>
                    <!-- Atributos para crear ciclo -->
                    <group>
                        <field name="name"/>
                        <field name="descripcion"/>
                    </group>
                    <!-- Esto es para poder crear un nuevo modulo desde el ciclo que estemos creando o editando -->
                    <notebook>
                        <page string="Módulos">
    ...
    <!-- Aqui se hace la visualización en lista -->
    <record id="view_ciclo_list" model="ir.ui.view">
        <field name="name">instituto.ciclo.list</field>
        <field name="model">instituto.ciclo</field>
        <field name="arch" type="xml">
            <list string="Ciclos">
                <!-- Atributos que se ven en la lista, el many2many_tags es una forma de visualizacion sencilla para poder ver varias modulos en un ciclo -->
                <field name="name"/>
    ...
    <!-- Aqui se determina lo que va haber en la vista que es un form y una list -->
    ...
    <!-- Aqui creamos el boton del menu de arriba para cambiar entre vistas -->
    <menuitem id="menu_instituto_root" name="Instituto"/>
    <menuitem id="menu_instituto_ciclos" name="Ciclos formativos" parent="menu_instituto_root" action="action_ciclo"/>
</odoo>
\end{lstlisting}
\end{figure}

\begin{figure}[H] Vista alumno
\begin{lstlisting}
<odoo>
    <!-- Aqui se hace un formulario para crear nuevos alumnos -->
    <record id="view_alumno_form" model="ir.ui.view">
        ...
        <field name="arch" type="xml">
            <form string="Alumno">
                <sheet>
                    <group>
                        <!-- Atributos para crear alumnos -->
                        <field name="name"/>
                        <field name="dni"/>
                        <field name="fecha_nacimiento"/>
                    </group>
                    <group>
                        <!-- Es un atributo para añadir modulos a los alumnos, se ven de la forma many2many -->
                        <field name="modulo_ids" widget="many2many_tags"/>
                    </group>
                </sheet>
            </form>
    ...
    <record id="view_alumno_list" model="ir.ui.view">
        <field name="name">instituto.alumno.list</field>
        <field name="model">instituto.alumno</field>
        <field name="arch" type="xml">
            <list string="Alumnos">
                <!-- Atributos que se ven en la lista -->
                <field name="name"/>
                <field name="dni"/>
            </list>
        </field>
    ...
    <!-- Aqui creamos el boton del menu de arriba para cambiar entre vistas -->
    <menuitem id="menu_instituto_alumnos" name="Alumnos" parent="menu_instituto_root" action="action_alumno"/>
</odoo>
\end{lstlisting}
\end{figure}

\begin{figure}[H] Vista profesor
\begin{lstlisting}
<odoo>
    <!-- Aqui se hace un formulario para crear nuevos profesores -->
    <record id="view_profesor_form" model="ir.ui.view">
        ...
        <field name="arch" type="xml">
            <form string="Profesor">
                <sheet>
                    <group>
                        <!-- Atributos para crear profesores -->
                        <field name="name"/>
                        <field name="departamento"/>
                        <field name="numero_colegiado"/>
                    </group>
                    <group>
                        <!-- Es un atributo para añadir modulos a los profesores, se ven de la forma many2many -->
                        <field name="modulo_ids" widget="many2many_tags" string="Módulos que imparte"/>
                    </group>
                </sheet>
            </form>
        </field>
    ...
    <record id="view_profesor_list" model="ir.ui.view">
        <field name="name">instituto.profesor.list</field>
        <field name="model">instituto.profesor</field>
        <field name="arch" type="xml">
    ...
    <!-- Aqui creamos el boton del menu de arriba para cambiar entre vistas -->
    <menuitem id="menu_instituto_profesores" name="Profesores" parent="menu_instituto_root" action="action_profesor"/>
</odoo>
\end{lstlisting}
\end{figure}

\begin{figure}[H] Vista modulo
\begin{lstlisting}
<odoo>
     <!-- Aqui se hace un formulario para crear nuevos modulos -->
    <record id="view_modulo_form" model="ir.ui.view">
        <field name="name">instituto.modulo.form</field>
        <field name="model">instituto.modulo</field>
        <field name="arch" type="xml">
            <form string="Módulo">
                <sheet>
                    <group>
                        <!-- Atributos para crear modulos -->
                        <field name="name"/>
                        <field name="codigo"/>
                    </group>
                    <group>
                        <!-- Atributos para crear modulos que son relaciones -->
                        <field name="ciclo_id"/>
                        <field name="profesor_id"/>
                    </group>
                    <group>
                        <!-- Es un atributo para añadir alumnos a los modulos, se ven de la forma many2many -->
    ...
    <record id="view_modulo_list" model="ir.ui.view">
        <field name="name">instituto.modulo.list</field>
        <field name="model">instituto.modulo</field>
        <field name="arch" type="xml">
            <list string="Módulos">
                <!-- Atributos que se ven en la lista -->
    ...
    <!-- Aqui creamos el boton del menu de arriba para cambiar entre vistas -->
    <menuitem id="menu_instituto_modulos" name="Módulos" parent="menu_instituto_root" action="action_modulo"/>
</odoo>
\end{lstlisting}
\end{figure}
